...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--config',type=Path,required=True); ap.add_argument('--dataset-root',type=Path,required=True); ap.add_argument('--dataset-manifest',type=Path,required=True); ap.add_argument('--init-checkpoint',type=Path,required=True); ap.add_argument('--output',type=Path,required=True); ap.add_argument('--epochs',type=int,default=20); ap.add_argument('--seed',type=int,default=42); ap.add_argument('--fraction',type=float,choices=FRACTIONS,default=None)
