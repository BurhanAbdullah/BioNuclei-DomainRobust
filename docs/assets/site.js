document.addEventListener('DOMContentLoaded', function () {
  ...
  /* Keep detailed current-foundation material confined to the BioNuclei research pages. */
  ...
  if (toggle && links) {
    ...
    links.addEventListener('click',function(e){if(e.target.tagName.toLowerCase()==='a'){links.classList.remove('open');toggle.setAttribute('aria-expanded','false');toggle.setAttribute('aria-label','Open navigation');}});
  }
